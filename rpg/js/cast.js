...
<defs><linearGradient id="cvBg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#241a08"/><stop offset="1" stop-color="#0d0b06"/></linearGradient></defs>
<rect width="96" height="96" rx="18" fill="url(#cvBg)"/>
<rect width="96" height="96" rx="18" fill="none" stroke="#fbbf24" stroke-opacity=".35" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#15120c" stroke="#fbbf24" stroke-opacity=".45" stroke-width="1.2"/>
<path d="M40 66 L48 78 L56 66 L52 64 L48 70 L44 64 Z" fill="#e8e4d8"/>
<path d="M48 74 L44.5 79 L47 92 L49 92 L51.5 79 Z" fill="#fbbf24"/>
<path d="M20 84 L34 76" stroke="#fbbf24" stroke-opacity=".5" stroke-width="1.4"/>
...
<rect x="34" y="39" width="12" height="8" rx="3" fill="#0d0b06" stroke="#fbbf24" stroke-width="1.2"/>
<rect x="50" y="39" width="12" height="8" rx="3" fill="#0d0b06" stroke="#fbbf24" stroke-width="1.2"/>
<path d="M46 42.5 H50" stroke="#fbbf24" stroke-width="1.2"/>
...
<defs><linearGradient id="clBg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#1a1430"/><stop offset="1" stop-color="#0b0a14"/></linearGradient></defs>
<rect width="96" height="96" rx="18" fill="url(#clBg)"/>
<rect width="96" height="96" rx="18" fill="none" stroke="#a78bfa" stroke-opacity=".35" stroke-width="1.5"/>
<path d="M10 96 C16 76 30 68 48 68 C66 68 80 76 86 96 Z" fill="#e8e6f2" stroke="#a78bfa" stroke-opacity=".5" stroke-width="1.2"/>
...
<circle cx="40" cy="44" r="7.5" fill="none" stroke="#a78bfa" stroke-width="1.8"/>
<circle cx="56" cy="44" r="7.5" fill="none" stroke="#a78bfa" stroke-width="1.8"/>
<path d="M47.5 44 H48.5 M32.5 43 L28 41 M63.5 43 L68 41" stroke="#a78bfa" stroke-width="1.6"/>
...
<defs><linearGradient id="ckBg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#0c2318"/><stop offset="1" stop-color="#07110b"/></linearGradient></defs>
<rect width="96" height="96" rx="18" fill="url(#ckBg)"/>
<rect width="96" height="96" rx="18" fill="none" stroke="#34d399" stroke-opacity=".35" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#123527" stroke="#34d399" stroke-opacity=".5" stroke-width="1.2"/>
...
<!-- 耳机 -->
<path d="M28 38 C28 22 38 14 48 14 C58 14 68 22 68 38" fill="none" stroke="#34d399" stroke-width="2.6" stroke-linecap="round"/>
<rect x="24" y="36" width="8" height="13" rx="4" fill="#34d399"/>
<rect x="64" y="36" width="8" height="13" rx="4" fill="#34d399"/>
<!-- 耳环 -->
<circle cx="30" cy="52" r="1.8" fill="#34d399"/><circle cx="66" cy="52" r="1.8" fill="#34d399"/>
...
<defs><linearGradient id="cmBg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#2a1020"/><stop offset="1" stop-color="#120810"/></linearGradient></defs>
<rect width="96" height="96" rx="18" fill="url(#cmBg)"/>
<rect width="96" height="96" rx="18" fill="none" stroke="#f472b6" stroke-opacity=".4" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#3d1230" stroke="#f472b6" stroke-opacity=".5" stroke-width="1.2"/>
<path d="M36 66 L48 76 L60 66 L56 63 L48 68 L40 63 Z" fill="#e8dce8"/>
...
<path d="M30 40 C28 26 38 17 48 17 C58 17 68 26 66 40" fill="none" stroke="#f472b6" stroke-width="2.4" stroke-linecap="round"/>
<rect x="26" y="38" width="7" height="11" rx="3.5" fill="#f472b6"/>
<rect x="63" y="38" width="7" height="11" rx="3.5" fill="#f472b6"/>
<path d="M63 44 C60 50 54 52 50 51" fill="none" stroke="#f472b6" stroke-width="1.8"/>
<circle cx="50" cy="51" r="2.2" fill="#f472b6"/>
...
<defs><linearGradient id="crBg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#2a1608"/><stop offset="1" stop-color="#120a05"/></linearGradient></defs>
<rect width="96" height="96" rx="18" fill="url(#crBg)"/>
<rect width="96" height="96" rx="18" fill="none" stroke="#fb923c" stroke-opacity=".35" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#331c0d" stroke="#fb923c" stroke-opacity=".5" stroke-width="1.2"/>
<rect x="26" y="82" width="14" height="7" rx="2" fill="#fb923c" fill-opacity=".85"/>
...
<!-- 老花镜（垂在鼻尖） -->
<path d="M36 44 h24" stroke="#e8e0d0" stroke-width="1.4"/>
<path d="M38 44 C38 41 42 40 44 44 M52 44 C54 40 58 41 58 44" fill="none" stroke="#e8e0d0" stroke-width="1.3"/>
<!-- 慈祥眯眼 -->
...
<defs><linearGradient id="cdBg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#0e1c30"/><stop offset="1" stop-color="#080f18"/></linearGradient></defs>
<rect width="96" height="96" rx="18" fill="url(#cdBg)"/>
<rect width="96" height="96" rx="18" fill="none" stroke="#60a5fa" stroke-opacity=".4" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#13233d" stroke="#60a5fa" stroke-opacity=".5" stroke-width="1.2"/>
<path d="M40 66 L48 76 L56 66 L52 64 L48 69 L44 64 Z" fill="#e8ecf4"/>
<path d="M48 74 L45 80 L46.5 92 L49.5 92 L51 80 Z" fill="#60a5fa"/>
...
<rect x="34" y="41" width="11" height="8" rx="2" fill="none" stroke="#60a5fa" stroke-width="1.7"/>
<rect x="51" y="41" width="11" height="8" rx="2" fill="none" stroke="#60a5fa" stroke-width="1.7"/>
<path d="M45 44.5 H51" stroke="#60a5fa" stroke-width="1.6"/>
...
<defs><linearGradient id="csBg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#08222a"/><stop offset="1" stop-color="#05141a"/></linearGradient>
...
<rect width="96" height="96" rx="18" fill="none" stroke="#22d3ee" stroke-opacity=".4" stroke-width="1.5"/>
<line x1="48" y1="10" x2="48" y2="22" stroke="#22d3ee" stroke-width="2"/>
<circle cx="48" cy="9" r="3" fill="#22d3ee"><animate attributeName="opacity" values="1;.3;1" dur="1.6s" repeatCount="indefinite"/></circle>
<rect x="22" y="22" width="52" height="38" rx="8" fill="#0a141a" stroke="#22d3ee" stroke-width="2"/>
...
<g stroke="#22d3ee" stroke-opacity=".45" stroke-width="1.2">
...
<path d="M30 68 L66 68 L70 76 L26 76 Z" fill="#123a45" stroke="#22d3ee" stroke-opacity=".5" stroke-width="1.4"/>
...
<defs><linearGradient id="cyBg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#101a24"/><stop offset="1" stop-color="#080d13"/></linearGradient>
<linearGradient id="cyVis" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#22d3ee" stop-opacity=".9"/><stop offset=".5" stop-color="#134e5a"/><stop offset="1" stop-color="#a78bfa" stop-opacity=".8"/></linearGradient></defs>
<rect width="96" height="96" rx="18" fill="url(#cyBg)"/>
<rect width="96" height="96" rx="18" fill="none" stroke="#7dd8e8" stroke-opacity=".35" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#0f1720" stroke="#7dd8e8" stroke-opacity=".4" stroke-width="1.2"/>
...
<path d="M37 34 L44 33 L40 45 Z" fill="#dffaff" fill-opacity=".55"/>
...
<defs>
<linearGradient id="bBg" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#1c0808"/><stop offset="1" stop-color="#0a0405"/></linearGradient>
<radialGradient id="bGlow" cx=".5" cy=".35" r=".7"><stop offset="0" stop-color="#f87171" stop-opacity=".22"/><stop offset="1" stop-color="#f87171" stop-opacity="0"/></radialGradient>
</defs>
<rect width="200" height="120" rx="14" fill="url(#bBg)"/>
<rect width="200" height="120" rx="14" fill="url(#bGlow)"/>
<rect x="6" y="6" width="188" height="108" rx="10" fill="none" stroke="#f87171" stroke-opacity=".55" stroke-width="1.5" stroke-dasharray="7 5"/>
<!-- 中央大法官 -->
...
<circle cx="100" cy="46" r="3" fill="#fbbf24"><animate attributeName="opacity" values="1;.4;1" dur="2.4s" repeatCount="indefinite"/></circle>
<path d="M96 54 Q100 57 104 54" fill="none" stroke="#f87171" stroke-width="1.6"/>
<rect x="90" y="86" width="20" height="7" rx="2" fill="#f87171" fill-opacity=".8"/>
<!-- 左右判官 -->
...
<circle cx="50" cy="53" r="2.4" fill="#f87171"><animate attributeName="opacity" values=".3;1;.3" dur="3s" repeatCount="indefinite"/></circle>
<circle cx="150" cy="53" r="2.4" fill="#f87171"><animate attributeName="opacity" values="1;.3;1" dur="3s" repeatCount="indefinite"/></circle>
<!-- 法槌 -->
...
<g fill="#f87171" font-family="monospace" font-size="11" letter-spacing="3">
<text x="100" y="18" text-anchor="middle" fill="#f87171" opacity=".9">THE REVIEW</text>
</g>
</svg>`;

  /* ---------- 元数据（门户展示用） ---------- */
  const META = {
    victor: { name: 'Victor', role: 'CEO · 会议室里最锋利的人', color: '#fbbf24', quote: '“我改一下招聘流程——以后 JD 里会写：要求达到 ta 的一半。”' },
    lin:    { name: '林博士', role: 'CTO · 数据的翻译官', color: '#a78bfa', quote: '“数据不会说谎。你是我带过的新人里，最接近『产品直觉』的一个。”' },
    kai:    { name: 'Kai', role: 'ML 工程师 · 上线守门人', color: '#34d399', quote: '“先跑通，再跑快。灰度、实验、回滚——发布三件套。”' },
    maya:   { name: 'Maya', role: 'Growth · 增长的良心', color: '#f472b6', quote: '“增长要的是留存，不是烟花。”' },
    raj:    { name: 'Raj', role: '客服负责人 · 二十年工龄的定海神针', color: '#fb923c', quote: '“我见过七次大故障。别慌，先止血，再复盘。”' },
    dana:   { name: 'Dana', role: '企业销售 · 承诺的重量', color: '#60a5fa', quote: '“客户买的不是模型，是不出事。”' },
    sys:    { name: 'NOVA 终端', role: 'SYSTEM · 你的工位本身', color: '#22d3ee', quote: '“SYSTEM ONLINE. 请开始你的试用期。”' },
    you:    { name: '你', role: 'Product Associate · Season 1', color: '#7dd8e8', quote: '“你的武器不是代码，是判断力。”' }
  };
