...
(function () {
  ...
  const CIN_OPEN = [
    { h: '[SHUAMONE 耍门 · 档案馆]', lines: ['在遗忘之潮的边缘，有一座学院。', '它赶在每条知识沉没之前，把它打捞上岸，铸成塔。'] },
    { h: '[沙盘编号 S1 · 平行世界]', lines: ['现在，你将走进学院的实战沙盘——', '一家名为 NOVA·AI 的公司。', '十周试用期。沙盘里的一切后果，都是真的——对沙盘而言。'] },
    { h: '', lines: ['规则只有一条，古老而公平：', '知识不会遗忘你。直到你，掌握它。'] },
    { h: '[WEEK 01 · 试用期开始]', slam: true, lines: [] }
  ];
  const CIN_REVIEW = [
    { h: '[第十周 · 夜]', lines: ['会议室的灯亮了。三个影子依次落座，没有人说话。'] },
