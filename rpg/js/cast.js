...
<rect width="96" height="96" rx="18" fill="none" stroke="#C9962E" stroke-opacity=".35" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#15120c" stroke="#C9962E" stroke-opacity=".45" stroke-width="1.2"/>
<path d="M40 66 L48 78 L56 66 L52 64 L48 70 L44 64 Z" fill="#e8e4d8"/>
<path d="M48 74 L44.5 79 L47 92 L49 92 L51.5 79 Z" fill="#C9962E"/>
<path d="M20 84 L34 76" stroke="#C9962E" stroke-opacity=".5" stroke-width="1.4"/>
...
<rect x="34" y="39" width="12" height="8" rx="3" fill="#0d0b06" stroke="#C9962E" stroke-width="1.2"/>
<rect x="50" y="39" width="12" height="8" rx="3" fill="#0d0b06" stroke="#C9962E" stroke-width="1.2"/>
<path d="M46 42.5 H50" stroke="#C9962E" stroke-width="1.2"/>
...
<rect width="96" height="96" rx="18" fill="none" stroke="#AC9CC8" stroke-opacity=".35" stroke-width="1.5"/>
<path d="M10 96 C16 76 30 68 48 68 C66 68 80 76 86 96 Z" fill="#e8e6f2" stroke="#AC9CC8" stroke-opacity=".5" stroke-width="1.2"/>
...
<circle cx="40" cy="44" r="7.5" fill="none" stroke="#AC9CC8" stroke-width="1.8"/>
<circle cx="56" cy="44" r="7.5" fill="none" stroke="#AC9CC8" stroke-width="1.8"/>
<path d="M47.5 44 H48.5 M32.5 43 L28 41 M63.5 43 L68 41" stroke="#AC9CC8" stroke-width="1.6"/>
...
<rect width="96" height="96" rx="18" fill="none" stroke="#6FC0A4" stroke-opacity=".35" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#123527" stroke="#6FC0A4" stroke-opacity=".5" stroke-width="1.2"/>
...
<!-- 耳机 -->
<path d="M28 38 C28 22 38 14 48 14 C58 14 68 22 68 38" fill="none" stroke="#6FC0A4" stroke-width="2.6" stroke-linecap="round"/>
<rect x="24" y="36" width="8" height="13" rx="4" fill="#6FC0A4"/>
<rect x="64" y="36" width="8" height="13" rx="4" fill="#6FC0A4"/>
<!-- 耳环 -->
<circle cx="30" cy="52" r="1.8" fill="#6FC0A4"/><circle cx="66" cy="52" r="1.8" fill="#6FC0A4"/>
...
<rect width="96" height="96" rx="18" fill="none" stroke="#C96A9E" stroke-opacity=".4" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#3d1230" stroke="#C96A9E" stroke-opacity=".5" stroke-width="1.2"/>
...
<path d="M30 40 C28 26 38 17 48 17 C58 17 68 26 66 40" fill="none" stroke="#C96A9E" stroke-width="2.4" stroke-linecap="round"/>
<rect x="26" y="38" width="7" height="11" rx="3.5" fill="#C96A9E"/>
<rect x="63" y="38" width="7" height="11" rx="3.5" fill="#C96A9E"/>
<path d="M63 44 C60 50 54 52 50 51" fill="none" stroke="#C96A9E" stroke-width="1.8"/>
<circle cx="50" cy="51" r="2.2" fill="#C96A9E"/>
...
<rect width="96" height="96" rx="18" fill="none" stroke="#CC7440" stroke-opacity=".35" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#331c0d" stroke="#CC7440" stroke-opacity=".5" stroke-width="1.2"/>
<rect x="26" y="82" width="14" height="7" rx="2" fill="#CC7440" fill-opacity=".85"/>
...
<rect width="96" height="96" rx="18" fill="none" stroke="#4A7EC0" stroke-opacity=".4" stroke-width="1.5"/>
<path d="M8 96 C14 74 30 66 48 66 C66 66 82 74 88 96 Z" fill="#13233d" stroke="#4A7EC0" stroke-opacity=".5" stroke-width="1.2"/>
<path d="M40 66 L48 76 L56 66 L52 64 L48 69 L44 64 Z" fill="#e8ecf4"/>
<path d="M48 74 L45 80 L46.5 92 L49.5 92 L51 80 Z" fill="#4A7EC0"/>
...
<rect x="34" y="41" width="11" height="8" rx="2" fill="none" stroke="#4A7EC0" stroke-width="1.7"/>
<rect x="51" y="41" width="11" height="8" rx="2" fill="none" stroke="#4A7EC0" stroke-width="1.7"/>
<path d="M45 44.5 H51" stroke="#4A7EC0" stroke-width="1.6"/>
...
<rect width="96" height="96" rx="18" fill="none" stroke="#7CB8D4" stroke-opacity=".4" stroke-width="1.5"/>
<line x1="48" y1="10" x2="48" y2="22" stroke="#7CB8D4" stroke-width="2"/>
<circle cx="48" cy="9" r="3" fill="#7CB8D4"><animate attributeName="opacity" values="1;.3;1" dur="1.6s" repeatCount="indefinite"/></circle>
<rect x="22" y="22" width="52" height="38" rx="8" fill="#0a141a" stroke="#7CB8D4" stroke-width="2"/>
...
<g stroke="#7CB8D4" stroke-opacity=".45" stroke-width="1.2">
...
<path d="M30 68 L66 68 L70 76 L26 76 Z" fill="#123a45" stroke="#7CB8D4" stroke-opacity=".5" stroke-width="1.4"/>
...
<linearGradient id="cyVis" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#7CB8D4" stop-opacity=".9"/><stop offset=".5" stop-color="#134e5a"/><stop offset="1" stop-color="#AC9CC8" stop-opacity=".8"/></linearGradient></defs>
...
<radialGradient id="bGlow" cx=".5" cy=".35" r=".7"><stop offset="0" stop-color="#CC6B6B" stop-opacity=".22"/><stop offset="1" stop-color="#CC6B6B" stop-opacity="0"/></radialGradient>
</defs>
<rect width="200" height="120" rx="14" fill="url(#bBg)"/>
<rect width="200" height="120" rx="14" fill="url(#bGlow)"/>
<rect x="6" y="6" width="188" height="108" rx="10" fill="none" stroke="#CC6B6B" stroke-opacity=".55" stroke-width="1.5" stroke-dasharray="7 5"/>
<!-- 中央大法官 -->
...
<circle cx="100" cy="46" r="3" fill="#C9962E"><animate attributeName="opacity" values="1;.4;1" dur="2.4s" repeatCount="indefinite"/></circle>
<path d="M96 54 Q100 57 104 54" fill="none" stroke="#CC6B6B" stroke-width="1.6"/>
<rect x="90" y="86" width="20" height="7" rx="2" fill="#CC6B6B" fill-opacity=".8"/>
<!-- 左右判官 -->
...
<circle cx="50" cy="53" r="2.4" fill="#CC6B6B"><animate attributeName="opacity" values=".3;1;.3" dur="3s" repeatCount="indefinite"/></circle>
<circle cx="150" cy="53" r="2.4" fill="#CC6B6B"><animate attributeName="opacity" values="1;.3;1" dur="3s" repeatCount="indefinite"/></circle>
<!-- 法槌 -->
...
<g fill="#CC6B6B" font-family="monospace" font-size="11" letter-spacing="3">
<text x="100" y="18" text-anchor="middle" fill="#CC6B6B" opacity=".9">THE REVIEW</text>
</g>
</svg>`;

  /* ---------- 元数据（门户展示用） ---------- */
  const META = {
    victor: { name: 'Victor', role: 'CEO · 会议室里最锋利的人', color: '#C9962E', quote: '“我改一下招聘流程——以后 JD 里会写：要求达到 ta 的一半。”' },
    lin:    { name: '林博士', role: 'CTO · 数据的翻译官', color: '#AC9CC8', quote: '“数据不会说谎。你是我带过的新人里，最接近『产品直觉』的一个。”' },
    kai:    { name: 'Kai', role: 'ML 工程师 · 上线守门人', color: '#6FC0A4', quote: '“先跑通，再跑快。灰度、实验、回滚——发布三件套。”' },
    maya:   { name: 'Maya', role: 'Growth · 增长的良心', color: '#C96A9E', quote: '“增长要的是留存，不是烟花。”' },
    raj:    { name: 'Raj', role: '客服负责人 · 二十年工龄的定海神针', color: '#CC7440', quote: '“我见过七次大故障。别慌，先止血，再复盘。”' },
    dana:   { name: 'Dana', role: '企业销售 · 承诺的重量', color: '#4A7EC0', quote: '“客户买的不是模型，是不出事。”' },
    sys:    { name: 'NOVA 终端', role: 'SYSTEM · 你的工位本身', color: '#7CB8D4', quote: '“SYSTEM ONLINE. 请开始你的试用期。”' },
