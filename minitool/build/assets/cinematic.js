...
window.CINEMA = (function () {
  ...
  function injectStyles() {
    ...
    st.id = 'cinemaStyles';
    st.textContent =
      '#cinemaOverlay{position:fixed;top:0;right:0;bottom:0;left:0;z-index:900;display:none;flex-direction:column;justify-content:center;align-items:center;background:rgba(4,6,10,.97);cursor:pointer;font-family:ui-monospace,\'SF Mono\',Menlo,Consolas,monospace;user-select:none}' +
      ...
      '.cin-progress{position:absolute;bottom:13%;left:5%;z-index:3;display:flex}' +
      '.cin-progress i + i{margin-left:6px}' +
